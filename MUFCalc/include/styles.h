...
"QWidget{background-color:transparent;color:#1a1a2e;"
  "font-family:'Segoe UI','Ubuntu','Liberation Sans',Arial,sans-serif;font-size:13.5px;}"
...
"QMenu::item{padding:7px 24px;font-size:13.5px;}"
...
"QStatusBar{background:#eef4f9;border-top:1px solid #d1d8e0;color:#1a3a5c;"
  "font-size:11.5px;padding:3px 12px;font-family:'Courier New',monospace;}"
// Scrollbars – subtle
...
"QGroupBox{color:#1a3a5c;border:none;border-top:2px solid #1a3a5c;"
  ...
  "font-weight:700;font-size:11px;letter-spacing:1.2px;background:transparent;}"
"QGroupBox::title{subcontrol-origin:margin;left:0;padding:2px 10px;"
  "background:#1a3a5c;color:white;font-size:10px;letter-spacing:1px;}"
// Tabs
...
"QTabBar::tab{background:#e8eff5;color:#4a5568;padding:7px 18px;"
  ...
  "border-radius:4px 4px 0 0;font-size:12.5px;font-weight:600;margin-right:2px;}"
...
"QListWidget::item{padding:9px 14px;border-bottom:1px solid #eef1f5;font-size:13.5px;}"
...
"QTextEdit,QTextBrowser{background:white;border:none;border-left:3px solid #1a3a5c;"
  "color:#1a1a2e;padding:10px;font-size:13.5px;}"
"QFrame{border:none;}"
    );
}
...
"QLineEdit,QDoubleSpinBox,QSpinBox,QDateEdit,QComboBox{"
  ...
  "border-radius:0;color:#000000;padding:6px 4px;font-size:13.5px;"
...
"QPushButton{background:#2a6020;color:white;border:none;"
  "border-radius:3px;padding:8px 22px;font-weight:700;font-size:13.5px;}"
...
"QPushButton{background:white;color:#1a3a5c;border:1.5px solid #1a3a5c;"
  "border-radius:3px;padding:7px 18px;font-size:13.5px;font-weight:600;}"
...
"QPushButton{background:#fef2f2;color:#b91c1c;border:1px solid #fca5a5;"
  "border-radius:3px;padding:6px 14px;font-size:12.5px;font-weight:600;}"
...
"QHeaderView::section{background:#1a3a5c;color:white;font-weight:700;"
  "font-size:11px;letter-spacing:0.6px;padding:8px 12px;border:none;"
