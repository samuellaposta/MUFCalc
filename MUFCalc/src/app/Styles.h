...
//  LIGHT institutional theme. Font scale aligned with the
//  Virtual Facility "Scenario" page (Segoe UI, larger sizes).
// ══════════════════════════════════════════════════════════════════
namespace Styles {
...
static const QString BG_SIDEBAR = "#f0f4f8";
static const QString BG_BASE    = "#f7f9fb";
...
"QWidget{background-color:transparent;color:#1a1a2e;"
  "font-family:'Segoe UI','Ubuntu','Liberation Sans',Arial,sans-serif;font-size:14px;}"
"QMainWindow{background-color:#ffffff;}"
"QDialog{background-color:#ffffff;}"
"QMenuBar{background:#1a3a5c;color:white;"
  "border-bottom:2px solid #2d5680;padding:3px 8px;"
  "font-size:14px;font-weight:600;}"
"QMenuBar::item{padding:7px 18px;border-radius:3px;color:white;}"
"QMenuBar::item:selected{background:#2d5680;}"
"QMenu{background:white;border:1px solid #d1d8e0;color:#1a1a2e;"
  "border-radius:4px;padding:4px 0;}"
"QMenu::item{padding:8px 26px;font-size:14px;}"
...
"QStatusBar{background:#eef4f9;border-top:1px solid #d1d8e0;color:#1a3a5c;"
  "font-size:13px;padding:4px 14px;font-family:'Courier New',monospace;}"
"QScrollBar:vertical{background:#f0f4f8;width:10px;border-radius:5px;margin:2px;}"
"QScrollBar::handle:vertical{background:#b0c8dc;border-radius:5px;min-height:32px;}"
"QScrollBar::handle:vertical:hover{background:#1a3a5c;}"
"QScrollBar::add-line:vertical,QScrollBar::sub-line:vertical{height:0;}"
"QScrollBar:horizontal{background:#f0f4f8;height:10px;border-radius:5px;margin:2px;}"
"QScrollBar::handle:horizontal{background:#b0c8dc;border-radius:5px;min-width:32px;}"
"QScrollBar::add-line:horizontal,QScrollBar::sub-line:horizontal{width:0;}"
"QSplitter::handle{background:#d1d8e0;}"
"QToolTip{background:#1a3a5c;color:white;border:none;padding:6px 12px;"
  "border-radius:4px;font-size:13px;}"
"QGroupBox{color:#1a3a5c;border:none;border-top:2px solid #1a3a5c;"
  "margin-top:20px;padding:14px 0 0 0;"
  "font-weight:700;font-size:13px;letter-spacing:1px;background:transparent;}"
"QGroupBox::title{subcontrol-origin:margin;left:0;padding:3px 12px;"
  "background:#1a3a5c;color:white;font-size:12px;letter-spacing:1px;}"
"QTabWidget::pane{border:1px solid #d1d8e0;"
  "background:rgba(255,255,255,0.97);margin-top:-1px;}"
"QTabBar::tab{background:#e8eff5;color:#4a5568;padding:9px 22px;"
  "border:1px solid #d1d8e0;border-bottom:none;"
  "border-radius:4px 4px 0 0;font-size:14px;font-weight:600;margin-right:2px;}"
...
"QListWidget::item{padding:10px 16px;border-bottom:1px solid #eef1f5;font-size:14px;}"
...
"QTextEdit,QTextBrowser{background:white;border:none;border-left:3px solid #1a3a5c;"
  "color:#1a1a2e;padding:12px;font-size:14px;}"
"QFrame{border:none;}"
    );
}
...
"QLineEdit,QDoubleSpinBox,QSpinBox,QDateEdit,QComboBox{"
  ...
  "border-radius:0;color:#000000;padding:7px 4px;font-size:14px;"
...
"QPushButton{background:#1a3a5c;color:white;border:none;"
  "border-radius:3px;padding:9px 24px;font-weight:700;"
...
"QPushButton{background:#2a6020;color:white;border:none;"
  "border-radius:3px;padding:9px 24px;font-weight:700;font-size:14px;}"
...
"QPushButton{background:white;color:#1a3a5c;border:1.5px solid #1a3a5c;"
  "border-radius:3px;padding:8px 20px;font-size:14px;font-weight:600;}"
...
"QPushButton{background:#fef2f2;color:#b91c1c;border:1px solid #fca5a5;"
  "border-radius:3px;padding:7px 16px;font-size:13px;font-weight:600;}"
...
"QTableWidget{background:white;alternate-background-color:#f4f8fb;"
  "border:none;gridline-color:#e8edf2;font-size:14px;"
  "color:#000000;selection-background-color:#c8dff0;selection-color:#0f2438;}"
"QTableWidget::item{padding:8px 12px;border:none;color:#000000;}"
"QHeaderView::section{background:#1a3a5c;color:white;font-weight:700;"
  "font-size:13px;letter-spacing:0.4px;padding:10px 12px;border:none;"
